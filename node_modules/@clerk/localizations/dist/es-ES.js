...
var esES = {
  ...
  signUp: {
    ...
    legalConsent: {
      checkbox: {
        ...
        label__termsOfServiceAndPrivacyPolicy: "He le\xEDdo y acepto los T\xE9rminos de Servicio y la Pol\xEDtica de Privacidad"
      },
      continue: {
  ...
  unstable__errors: {
    ...
    passwordComplexity: {
      maximumLength: "La contrase\xF1a no debe exceder los {{maxLength}} caracteres.",
      minimumLength: "La contrase\xF1a debe tener al menos {{minLength}} caracteres.",
      requireLowercase: "La contrase\xF1a debe contener al menos una letra min\xFAscula.",
      requireNumbers: "La contrase\xF1a debe contener al menos un n\xFAmero.",
      requireSpecialCharacter: "La contrase\xF1a debe contener al menos un car\xE1cter especial.",
      requireUppercase: "La contrase\xF1a debe contener al menos una letra may\xFAscula.",
      sentencePrefix: "Tu contrase\xF1a debe cumplir con los requisitos de complejidad."
    },
